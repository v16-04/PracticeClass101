...
PRACTICE1 now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<PRACTICE1_address\> \<monthly_payment_PRACTICE1\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PRACTICE1, _12_ times over the course of a year totaling _24000_ PRACTICE1.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<PRACTICE1_address\> \<monthly_payment_PRACTICE1\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PRACTICE1.
 ...
 * vote-many          - Vote on a PRACTICE1 initiative
 * vote-alias         - Vote on a PRACTICE1 initiative
 * vote               - Vote on a PRACTICE1 initiative/budget
