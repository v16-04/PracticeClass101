...
*Setup instructions for a gitian build of PRACTICE1 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the PRACTICE1
...
- [Building PRACTICE1](#building-PRACTICE1)
...
Clone the git repositories for PRACTICE1 and gitian and then checkout the PRACTICE1 version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the PRACTICE1 repository
...
To build PRACTICE1 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the PRACTICE1 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/PRACTICE1/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/PRACTICE1/PRACTICE1
...
For example:
```bash
URL=https://github.com/konez2k/PRACTICE1.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit PRACTICE1=${COMMIT} --url PRACTICE1=${URL} ../PRACTICE1/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit PRACTICE1=${COMMIT} --url PRACTICE1=${URL} ../PRACTICE1/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit PRACTICE1=${COMMIT} --url PRACTICE1=${URL} ../PRACTICE1/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/PRACTICE1-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/PRACTICE1-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/PRACTICE1-build.assert
```
...
[PRACTICE1/gitian.sigs](https://github.com/PRACTICE1/gitian.sigs/) repository, or if that's not possible to create a pull
request.
