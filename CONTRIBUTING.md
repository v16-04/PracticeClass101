Contributing to PRACTICE1 Core
==================================

The PRACTICE1 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PRACTICE1 Core project, and is not to be
confused with overall PRACTICE1 Network Protocol consensus changes.

Whether a pull request is merged into PRACTICE1 Core rests with the project merge
...
Patches that change PRACTICE1 consensus rules are considerably more involved than
...
Where a patch set proposes to change the PRACTICE1 consensus, it must have been
...
The project leader is the release manager for each PRACTICE1 Core release.
