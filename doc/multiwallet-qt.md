...
In order to support loading of multiple wallets in PRACTICE1-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is PRACTICE1.cpp.
...
Changes to PRACTICE1.cpp
----------------------
PRACTICE1.cpp is the entry point into PRACTICE1-qt, and as such, will require some minor modifications to provide hooks for
