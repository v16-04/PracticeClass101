...
#if defined(NDEBUG)
#error "PRACTICE1 cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uPRTC) are considered zero fee (for relaying and mining)
...
{
    RenameThread("PRACTICE1-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // PRACTICE1: We use certain sporks during IBD, so check to see if they are
