...
/** Utility functions used by the PRACTICE1 Qt UI.
 */
namespace GUIUtil
{
...
// Render PRACTICE1 addresses in monospace font
...
// Parse "PRACTICE1:" URI into recipient object, return true on successful parsing
