                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PRACTICE1 Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    web->setToolTip(QApplication::translate("OverviewPage", "Visit the official PRACTICE1 Website.", nullptr));
#endif // QT_NO_TOOLTIP
    web->setText(QApplication::translate("OverviewPage", "<a href=\"http://www.PRACTICE1.org\"><img src=\":/icons/blank\" width=\"102\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    facebook->setToolTip(QApplication::translate("OverviewPage", "Follow PRACTICE1 on Facebook.", nullptr));
#endif // QT_NO_TOOLTIP
    facebook->setText(QApplication::translate("OverviewPage", "<a href=\"https://www.facebook.com/PRACTICE1exchange\"><img src=\":/icons/blank\" width=\"21\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    twitter->setToolTip(QApplication::translate("OverviewPage", "Follow PRACTICE1 on Twitter.", nullptr));
#endif // QT_NO_TOOLTIP
    twitter->setText(QApplication::translate("OverviewPage", "<a href=\"https://twitter.com/PRACTICE1\"><img src=\":/icons/blank\" width=\"21\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    discord->setToolTip(QApplication::translate("OverviewPage", "Join the official PRACTICE1 Discord community.", nullptr));
#endif // QT_NO_TOOLTIP
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    //sendCoinsAction->setStatusTip(tr("Send coins to a PRACTICE1 address"));
    sendCoinsAction->setToolTip(tr("Send coins to a PRACTICE1 address"));
    ...
    //receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PRACTICE1: URIs)"));
    receiveCoinsAction->setToolTip(tr("Request payments (generates QR codes and PRACTICE1: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PRACTICE1 Core"), this);
    aboutAction->setStatusTip(tr("Show information about PRACTICE1 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PRACTICE1"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PRACTICE1 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PRACTICE1 addresses"));
    ...
    openAction->setStatusTip(tr("Open a PRACTICE1: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PRACTICE1 Core help message to get a list with possible PRACTICE1 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PRACTICE1 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PRACTICE1 network", "", count));
}
...
{
    QString strTitle = tr("PRACTICE1 Core"); // default title
